...
- `/hyperframes-skill-authoring` — Write or refactor HyperFrames animation skills (rules, blueprints, examples). Enforces the three-tier abstraction contract: rules teach atomic patterns, blueprints teach scene orchestration, examples are runnable ground truth.
