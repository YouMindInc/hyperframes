...
- **Composition is decided per‑scene by Phase 3 visual‑design** (`rules/`), not dictated preset‑wide.
...
§H ("Scene composition hints") is **deleted** from each preset. Composition (surface alternation, hero placement, card grids, element positioning) is decided per‑scene by Phase 3 visual‑design via **`rules/`**. §H content decomposes three ways:

| §H content                                                                                   | disposition                                                                                                                                      |
| -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Layout / composition (surface rotation, hero size+placement, grid columns/gaps, positioning) | **DELETE** → visual‑design owns it (`rules/composition.md`)                                                                         |
