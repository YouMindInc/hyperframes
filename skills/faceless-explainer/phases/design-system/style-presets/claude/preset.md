...
--cl-tile: color-mix(in srgb, var(--brand-primary) 5%, #f3eee4); /* the 30% card surface, one warm step down */
...
--brand-gradient: linear-gradient(135deg, var(--brand-accent), color-mix(in srgb, var(--brand-accent) 55%, var(--ink)));
...
:root {
  ...
  --f-mono-native: "JetBrains Mono", "IBM Plex Mono", "SFMono-Regular", Menlo, ui-monospace, monospace;
}
